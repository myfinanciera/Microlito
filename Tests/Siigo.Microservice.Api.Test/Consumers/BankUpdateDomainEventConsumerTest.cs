...
public class BankUpdateDomainEventConsumerTest
{
    private readonly Mock<IMediator> _mediator;
    private readonly Mock<IConsumerContext> _consumerContext;

    public BankUpdateDomainEventConsumerTest()
    {
    ...
    public async Task OnHandle_WhenReceivedBankUpdateDomainEvent_ReturnsSuccess(int bankId, string code, string name)
    {
        ...
        //_mediator
        //    .Setup(x=>x.Send(It.IsAny<UpdateBankCommandRequest>(), default))
        //    .Verifiable();
        ...
        //var bankUpdateDomainEventConsumer = new BankUpdateDomainEventConsumer(_mediator.Object);
        //bankUpdateDomainEventConsumer.Context = _consumerContext.Object;
        

        //// Act
        //await bankUpdateDomainEventConsumer.OnHandle(new MessageBase(), It.IsAny<string>());
