...
public sealed class BankUpdateDomainEventConsumer : ICustomerConsumer<MessageBase>
{
    private readonly IMediator _mediator;

    public BankUpdateDomainEventConsumer(IMediator mediator)
    {
        _mediator = mediator;
    }
    ...
    public async Task OnHandle(MessageBase _, string path)
    {
        ...
        await _mediator.Send(new UpdateBankCommandRequest(bank));
    }
